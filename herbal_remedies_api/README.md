...
- Use the token in requests: `Authorization: Token <your_token>`
...
- Configure a production database (e.g., PostgreSQL) and storage for media
- Issue and persist DRF auth tokens as needed
